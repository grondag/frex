 ...
 * <p>
 * 
 * Also handles creation of uniforms via one of the provided "uniform..."
...
public interface ShaderManager {
     ...
     *         compilation fails.
     */
    RenderMaterial shaderMaterial(RenderMaterial baseMaterial, Supplier<String> vertexSource,
